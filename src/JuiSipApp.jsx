...
const localFirebaseConfig = {
  apiKey: "AIzaSyC0p6wxrxkRORyQJg_VVYR_uIbaSGryNrg",
  authDomain: "jusip-app-backend.firebaseapp.com",
  projectId: "jusip-app-backend",
  storageBucket: "jusip-app-backend.firebasestorage.app",
  messagingSenderId: "63356850011",
  appId: "1:63356850011:web:32dbdc8a4c0867b965947e",
  measurementId: "G-YGW3F98CZM"
};
    ...
    try {
      ...
      const unsubscribe = onAuthStateChanged(userAuth, async (user) => {
        if (user) {
          ...
          cd   console.error("Firebase Auth Error:", e);
